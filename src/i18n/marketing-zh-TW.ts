...
const marketingChineseTraditionalMessages: TranslationMessages = {
  marketing: {
    nav: {
      features: "功能",
      pricing: "定價",
    ...
    landing: {
      hero: {
        kicker: "為成長型團隊打造",
        title: "面向現代企業的 CRM",
        subtitle: "Custly 幫助團隊以優雅高效的方式管理客戶關係",
        highlights: {
          quick_setup: "30 分鐘內完成 CRM 工作台上線",
          privacy_ready: "預設隱私優先，清楚的歸屬權",
          templates: "可重用的行業模板",
          analytics: "內建清晰的分析看板",
        },
        metrics: {
          active_teams: "正在使用的團隊",
          templates: "行業模板",
          time_saved: "跟進效率提升",
        },
      },
      search: {
        prompt: "我們能如何幫助你更好地管理客戶？",
        response: "好問題！",
      },
      trust: {
        title: "受到全球團隊信賴",
      ...
      value: {
        title: "站在巨人的肩膀上",
        description: "用 Custly 更深入地了解客戶，從而更快增長業務。",
        points: {
          relationships: {
            title: "關係優先",
            description: "記錄客戶背景，讓團隊保持一致。",
          },
          clarity: {
            title: "一眼清晰",
            description: "聚焦今天最重要的待辦與關鍵客戶。",
          },
          control: {
            title: "可控透明",
            description: "資料歸屬清楚，權限與稽核可追溯。",
          },
          momentum: {
            title: "成長節奏",
            description: "以簡潔儀表板持續追蹤進展。",
          },
        },
      },
      preview: {
        kicker: "即時預覽",
        title: "更安靜的控制台，更清晰的動作",
        subtitle: "虛擬資料，真實流程",
        note: "點擊查看示範，體驗完整流程。",
        stats: {
          deals: "進行中的交易",
      ...
      differentiators: {
        title: "我們的不同之處",
        subtitle: "市面上 CRM 工具眾多，Custly 有哪些獨特之處？",
        items: {
          scale: {
            title: "規模化",
            description: "一次管理數千聯繫人，並同時分析數據點。",
          },
          accuracy: {
            title: "準確性",
            description: "透過數據校驗與智能去重，提供更準確的 CRM。",
          },
          transparency: {
            title: "透明性",
            description: "所有操作可追溯，具備完整審計記錄。",
          },
          more_than_chat: {
            title: "不止聊天",
            description: "更豐富的互動表格與多步驟工作流。",
          },
        },
      },
      industries: {
        label: "行業",
        title: "服務多元行業",
        subtitle: "Custly 支持不同行業與業務場景",
        items: {
          professional_services: {
            title: "專業服務",
            description: "高效完成客戶入駐並維護關係",
          },
          technology: {
            title: "科技",
            description: "追蹤線索與客戶在銷售管道中的進展",
          },
          healthcare: {
            title: "醫療健康",
            description: "在合規前提下管理患者關係",
          },
          retail: {
            title: "零售與電商",
            description: "提升客戶忠誠度並促進複購",
          },
        },
      },
      features: {
        title: "你所需的一切",
        subtitle: "強大功能助你管理客戶關係",
        items: {
          contact_management: {
            title: "聯繫人管理",
            description: "透過自訂欄位與標籤集中管理所有聯繫人。",
          },
          deal_pipeline: {
            title: "交易管道",
          ...
          task_management: {
            title: "任務管理",
            description: "內建任務與提醒，避免錯過跟進。",
          },
          team_collaboration: {
            title: "團隊協作",
            description: "團隊協同處理交易與客戶互動。",
          },
          analytics: {
            title: "數據分析",
            description: "透過報告與儀表板取得洞察。",
          },
        },
      },
      faq: {
    ...
    features_page: {
      hero: {
        title: "管理客戶關係所需的一切",
        subtitle:
          "Custly 提供完整的工具套件，幫助你建立更強的客戶關係並推動增長。",
      },
      items: {
        contact_management: {
          title: "聯繫人管理",
          description:
            "將客戶資訊集中儲存並有序管理，輕鬆追蹤互動、偏好和歷史。",
        },
        company_profiles: {
          title: "公司檔案",
          description:
            "維護詳細公司記錄，支援自訂欄位、備註和關係映射，助力 B2B 銷售。",
        },
        deal_pipeline: {
          title: "交易管道",
          description:
            "用可視化看板追蹤交易進度，不錯過任何機會。",
        },
        notes_documents: {
          title: "備註與文件",
          description:
            "集中記錄與文件儲存，統一管理客戶溝通與檔案。",
        },
        task_management: {
          title: "任務管理",
          description:
    ...
    faq_page: {
      hero: {
        title: "常見問題",
        subtitle:
          "這裡彙總了關於 Custly 的常見問題。如果未找到答案，請聯繫我們的支持團隊。",
      },
      items: {
        what_is: {
          question: "什麼是 Custly？",
        ...
        pricing: {
          ...
          answer:
            "Custly 提供三種方案：月付、年付（節省約 30%）、終身（一次性付款）。支援美元（USD）、港幣（HKD）和人民幣（CNY）三種貨幣，你可以在定價頁面自由切換。所有方案功能完全相同，包含無限聯繫人和公司。每個新帳號都享有 14 天免費試用，無需信用卡。",
        },
        trial: {
          question: "購買前可以試用嗎？",
          answer:
        ...
        payment_methods: {
          question: "支援哪些付款方式？",
          answer:
            "我們透過 Stripe 支付處理商接受 Visa、Mastercard、American Express 等主流信用卡和借記卡，終身方案還支援支付寶。支援美元、港幣和人民幣三種貨幣。所有交易由 Stripe 安全處理。",
        },
        data_security: {
          question: "我的數據安全嗎？",
          answer:
        ...
        difference_plans: {
          question: "各方案有什麼區別？",
          answer:
            "三種方案功能完全相同，唯一的區別是計費方式：月付靈活彈性、年付節省約 30%、終身一次性付款無需再付費。支援美元、港幣和人民幣三種貨幣，選擇最適合你的方案即可。",
        },
        self_hosted: {
    ...
    auth: {
      login: {
        ...
        no_account: "還沒有帳號？",
        sign_up: "註冊",
        invalid_credentials: "郵箱或密碼錯誤，請檢查後重試",
        email_required: "請輸入郵箱地址",
        password_required: "請輸入密碼",
        user_not_found: "未找到該郵箱對應的帳號",
      ...
      signup: {
        title_new: "創建帳號",
        title_existing: "歡迎回來",
        subtitle_new: "創建第一個用戶帳號以開始使用",
        subtitle_existing: "你已經有帳號了，請登錄。",
        oauth_github: "使用 GitHub 繼續",
        oauth_google: "使用 Google 繼續",
        or_email: "或使用郵箱繼續",
        first_name: "名",
      ...
      reset_request: {
        title: "重置密碼",
        subtitle: "輸入郵箱以獲取重置鏈接。",
        email_label: "郵箱",
        email_placeholder: "name@example.com",
        submit: "發送重置鏈接",
        submitting: "正在發送...",
        success: "已發送重置鏈接，請檢查郵箱。",
        error: "發送失敗，請稍後再試。",
        sent_hint: "如果郵箱存在，你將很快收到重置鏈接。",
        back_to_login: "返回登錄",
      },
      reset_confirm: {
        title: "設置新密碼",
        ...
        error: "重置失敗，請稍後再試。",
        mismatch: "兩次密碼不一致。",
        missing_token: "重置鏈接無效或已過期。",
        done_hint: "現在可以使用新密碼登錄。",
        back_to_login: "返回登錄",
      },
    },
  },
...
export default marketingChineseTraditionalMessages;
